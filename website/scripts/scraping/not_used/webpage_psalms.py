...
if __name__ == "__main__":
    # Orthodox Psalter
    main('https://www.liturgies.net/Prayers/orthodoxpsalter.htm', "Psalms Raw/txt/orthodox/psalter.txt")

    # Coverdale Anglican Psalms
    #main("http://justus.anglican.org/resources/bcp/1928/Psalms1.htm", "Psalms Raw/txt/anglican/coverdale_1_of_3.txt")
    #main("http://justus.anglican.org/resources/bcp/1928/Psalms2.htm", "Psalms Raw/txt/anglican/coverdale_2_of_3.txt")
    #main("http://justus.anglican.org/resources/bcp/1928/Psalms3.htm", "Psalms Raw/txt/anglican/coverdale_3_of_3.txt")
